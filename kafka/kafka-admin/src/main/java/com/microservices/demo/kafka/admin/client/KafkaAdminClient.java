...
public class KafkaAdminClient {
    ...
    public void checkTopicsCreated() {
        ...
        for (String topic : kafkaConfigData.getTopicsNameToCreate()) {
    ...
    private CreateTopicsResult doCreateTopics(RetryContext retryContext) {
        List<String> topicNames = kafkaConfigData.getTopicsNameToCreate();
        LOG.info("Creating {} topic(s) attemp {}",
                 topicNames.size(),
    ...
    private Collection<TopicListing> doGetTopics(
        ...
        LOG.info("Reading kafka topic {} topic(s) attemp {}",
                 kafkaConfigData.getTopicsNameToCreate()
                                .toArray(),
                 retryContext.getRetryCount());
