...
import com.microservices.demo.elastic.query.ElasticQueryUtil;
...
public class TwitterElasticQueryClient implements ElasticQueryClient<TwitterIndexModel> {
    ...
    public TwitterIndexModel getIndexModelById(String id) {
        ...
        if (searchResult == null) {
            LOG.error("No document found at elasticsearch with id {}",
                      id);
    ...
    public List<TwitterIndexModel> getIndexModelByText(String text) {
        Query query = elasticQueryUtil.getSearchQueryByFieldText(elasticQueryConfigData.getTextField(),
                                                                 text);
        return search(query,
    ...
    public List<TwitterIndexModel> getAllIndexModels() {
        ...
        return search(query,
                      "{} number of documents retrieved successfully");
    }
